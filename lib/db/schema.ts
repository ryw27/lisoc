...
export const registration_drafts = pgTable(
    "registration_drafts",
    {
        ...
        expires: timestamp({ withTimezone: true, mode: "string" })
            .default(sql`CURRENT_TIMESTAMP + INTERVAL '72 hours'`)
            .notNull(),
    },
    (table) => [primaryKey({ columns: [table.email, table.name] })]
);
...
export const users = pgTable(
    ...
    (table) => [unique("users_name_key").on(table.name), unique("users_email_key").on(table.email)]
);

export const family = pgTable(
    "family",
    {
        familyid: integer().primaryKey().generatedAlwaysAsIdentity({
            name: "family_familyid_seq1",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const teacher = pgTable(
    "teacher",
    {
        teacherid: integer().primaryKey().generatedAlwaysAsIdentity({
            name: "teacher_teacherid_seq1",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
    ...
    (table) => [
        index("teacher_teacherid_idx").using(
            "btree",
            table.teacherid.asc().nullsLast().op("int4_ops")
        ),
        foreignKey({
            columns: [table.userid],
            foreignColumns: [users.id],
...
export const adminuser = pgTable(
    "adminuser",
    {
        adminid: integer().primaryKey().generatedAlwaysAsIdentity({
            name: "adminuser_userid_seq1",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const legacyAdminuser = pgTable("legacy_adminuser", {
    userid: integer().primaryKey().generatedAlwaysAsIdentity({
        name: "legacy_adminuser_userid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 2147483647,
...
export const classes = pgTable(
    "classes",
    {
        classid: integer().primaryKey().generatedAlwaysAsIdentity({
            name: "classes_classid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const agelist = pgTable("agelist", {
    ageid: smallint().primaryKey().generatedAlwaysAsIdentity({
        name: "agelist_ageid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 32767,
...
export const classrooms = pgTable(
    "classrooms",
    {
        roomid: smallint().primaryKey().generatedAlwaysAsIdentity({
            name: "classrooms_roomid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 32767,
    ...
    (table) => [index("roomid").using("btree", table.roomid.asc().nullsLast().op("int2_ops"))]
);

export const agerestriction = pgTable("agerestriction", {
    ageid: smallint().primaryKey().generatedAlwaysAsIdentity({
        name: "agerestriction_ageid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 32767,
...
export const dutycommittee = pgTable("dutycommittee", {
    dcid: integer().primaryKey().generatedAlwaysAsIdentity({
        name: "dutycommittee_dcid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 2147483647,
...
export const adminrole = pgTable("adminrole", {
    roleid: smallint().primaryKey().generatedAlwaysAsIdentity({
        name: "adminrole_roleid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 32767,
...
export const arrangement = pgTable(
    "arrangement",
    {
        arrangeid: integer().primaryKey().generatedAlwaysAsIdentity({
            name: "arrangement_arrangeid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const classtime = pgTable(
    "classtime",
    {
        timeid: smallint().primaryKey().generatedAlwaysAsIdentity({
            name: "sessions_timeid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 32767,
    ...
    (table) => [index("itmeid").using("btree", table.timeid.asc().nullsLast().op("int2_ops"))]
);

export const classtype = pgTable(
    "classtype",
    {
        typeid: smallint().primaryKey().generatedAlwaysAsIdentity({
            name: "classtype_typeid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 32767,
...
export const classregistration = pgTable(
    "classregistration",
    {
        // You can use { mode: "bigint" } if numbers are exceeding js number limitations
        regid: bigint({ mode: "number" }).primaryKey().generatedAlwaysAsIdentity({
            name: "classregistration_regid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
...
export const dutystatus = pgTable("dutystatus", {
    dutystatusid: smallint().primaryKey().generatedAlwaysAsIdentity({
        name: "dutystatus_dutystatusid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 32767,
...
export const dutyassignment = pgTable(
    "dutyassignment",
    {
        dutyassignid: integer().primaryKey().generatedAlwaysAsIdentity({
            name: "dutyassignment_dutyassignid_seq",
            startWith: 1000,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const regstatus = pgTable(
    "regstatus",
    {
        regstatusid: smallint().primaryKey().generatedAlwaysAsIdentity({
            name: "regstatus_regstatusid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 32767,
...
export const familybalancestatus = pgTable("familybalancestatus", {
    statusid: smallint().primaryKey().generatedAlwaysAsIdentity({
        name: "familybalancestatus_statusid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 32767,
...
export const feedback = pgTable("feedback", {
    recid: integer().primaryKey().generatedAlwaysAsIdentity({
        name: "feedback_recid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 2147483647,
...
export const feelist = pgTable("feelist", {
    feelistid: integer().primaryKey().generatedAlwaysAsIdentity({
        name: "feelist_feelistid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 2147483647,
...
export const paypalStatus = pgTable(
    "paypal_status",
    {
    ...
    (table) => [
        uniqueIndex("payapl_status_idx").using(
            "btree",
            table.tranactionid.asc().nullsLast().op("text_ops")
        ),
    ]
);
...
export const familybalance = pgTable(
    "familybalance",
    {
        balanceid: integer().primaryKey().generatedAlwaysAsIdentity({
            name: "familybalance_balanceid_seq",
            startWith: 10000,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const requeststatus = pgTable("requeststatus", {
    reqstatusid: smallint().primaryKey().generatedAlwaysAsIdentity({
        name: "requeststatus_reqstatusid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 32767,
...
export const familybalancetype = pgTable("familybalancetype", {
    typeid: smallint().primaryKey().generatedAlwaysAsIdentity({
        name: "familybalancetype_typeid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 32767,
...
export const parentdutyPb = pgTable(
    "parentduty_pb",
    {
        pdid: integer().generatedAlwaysAsIdentity({
            name: "parentduty_pb_pdid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
        ...
        scheduleddutydate: timestamp({ precision: 3, mode: "string" })
...
export const schoolcalendar = pgTable(
    "schoolcalendar",
    {
        calid: integer().primaryKey().generatedAlwaysAsIdentity({
            name: "schoolcalendar_calid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const scoredetail = pgTable("scoredetail", {
    scoredetailid: integer().primaryKey().generatedAlwaysAsIdentity({
        name: "scoredetail_scoredetailid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 2147483647,
...
export const studentscore = pgTable(
    "studentscore",
    {
        scoreid: integer().primaryKey().generatedAlwaysAsIdentity({
            name: "studentscore_scoreid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const scorerating = pgTable("scorerating", {
    ratingid: integer().primaryKey().generatedAlwaysAsIdentity({
        name: "scorerating_ratingid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 2147483647,
...
export const seatnum = pgTable("seatnum", {
    seatid: integer().primaryKey().generatedAlwaysAsIdentity({
        name: "seatnum_seatid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 2147483647,
...
export const studentscorefactor = pgTable(
    "studentscorefactor",
    {
        scorefactorid: integer().generatedAlwaysAsIdentity({
            name: "studentscorefactor_scorefactorid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const supports = pgTable("supports", {
    catid: integer().primaryKey().generatedAlwaysAsIdentity({
        name: "supports_catid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 2147483647,
...
export const student = pgTable(
    "student",
    {
        studentid: integer().primaryKey().generatedAlwaysAsIdentity({
            name: "student_studentid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const seasons = pgTable("seasons", {
    seasonid: smallint().primaryKey().generatedAlwaysAsIdentity({
        name: "seasons_seasonid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 32767,
    ...
    date4newfamilytoregister: timestamp({ mode: "string" })
        .default("1900-01-01 00:00:00")
        .notNull(),
    notes: text().default(""),
...
export const scorefactors = pgTable("scorefactors", {
    factorid: integer().primaryKey().generatedAlwaysAsIdentity({
        name: "scorefactors_factorid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 2147483647,
...
export const studentscorecomment = pgTable(
    "studentscorecomment",
    {
        scorecommentid: integer().primaryKey().generatedAlwaysAsIdentity({
            name: "studentscorecomment_scorecommentid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const studentscorerating = pgTable(
    "studentscorerating",
    {
        scoreratingid: integer().primaryKey().generatedAlwaysAsIdentity({
            name: "studentscorerating_scoreratingid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const scoreratingfactors = pgTable("scoreratingfactors", {
    ratingfactorid: integer().primaryKey().generatedAlwaysAsIdentity({
        name: "scoreratingfactors_ratingfactorid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 2147483647,
...
export const legacyTeacher = pgTable(
    "legacy_teacher",
    {
        teacherid: integer().primaryKey().generatedAlwaysAsIdentity({
            name: "legacy_teacher_teacherid_seq",
            startWith: 1,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const regchangerequest = pgTable(
    "regchangerequest",
    {
        requestid: integer().generatedAlwaysAsIdentity({
            name: "regchangerequest_requestid_seq",
            startWith: 10000,
            increment: 1,
            minValue: 1,
            maxValue: 2147483647,
...
export const legacyFamily = pgTable("legacy_family", {
    familyid: integer().primaryKey().generatedAlwaysAsIdentity({
        name: "legacy_family_familyid_seq",
        startWith: 1,
        increment: 1,
        minValue: 1,
        maxValue: 2147483647,
