...
export const familyFormSchema = z.object({
	...
	motherfirsten: z.string().max(50, { message: "Mother's first name must be at most 50 characters" }).optional(),
	motherlasten: z.string().max(50, { message: "Mother's last name must be at most 50 characters" }).optional(),
	mothernamecn: z.string().max(50, { message: "Mother's name (CN) must be at most 50 characters" }).optional(),
	...
	email2: z
        ...
        .regex(/^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.[a-zA-Z]{1,}$/, { message: "Invalid email address" })
        .optional()
        .default(""),
