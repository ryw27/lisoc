...
import { getPreviousSeason, getSelectOptions } from '@/lib/registration/semester';
...
export default async function StartSemesterPage() {
    ...
    return (
        <div className="container mx-auto w-3/4">
            <StartSemesterForm drafts={allArrangements} selectOptions={options} idMaps={idMaps} lastSeason={lastSeason}/>
        </div>
    )
}