...
import { type FamilyJoined } from "@/server/data-view/entity-configs/(people)/family";
...
export default function FamiliesLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <ConfigLayout entity="family" columns={columns}>
            {children}
        </ConfigLayout>
    );
}
