...
export default function AddAdminChoice({ fields }: { fields: FormSections[] }) {
	...
	return (
		<>
            <div className="flex flex-col items-center h-screen gap-2">
                <Button
                    variant="default"
                    title="Create Admin Registration Link and allow user to fill in their details"
                    onClick={() => setOpen(true)}
                    disabled={open}
                >
                    Create Admin Registration Link
                </Button>
                ...
                <AlertDialog open={open} onOpenChange={setOpen}>
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            <AlertDialogTitle>Create Admin Registration Link</AlertDialogTitle>
                        </AlertDialogHeader>
                        <AlertDialogDescription>
                            Create a registration link for a new admin user.
                        </AlertDialogDescription>
                        <Input
                            type="email"
                            placeholder="Email"
