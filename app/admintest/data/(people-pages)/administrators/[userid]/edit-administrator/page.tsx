...
export default async function EditAdministratorPage({
    ...
    const fields: EditFormField[] = [
        ...
        },
        {
            ...
            type: "text",
            required: true,
            defaultValue: currentAdmin.namelasten
        },
        {
            name: "namefirsten",
            label: "First Name",
            type: "text",
            required: true,
            defaultValue: currentAdmin.namefirsten
        },
        {
            name: "roleid",
            label: "Role",
            ...
            required: true,
            options: roleOptions,
            defaultValue: currentAdmin.roleid.toString()
        },
        {
            name: "address2",
            ...
            type: "text",
            required: false,
            defaultValue: currentAdmin.address2 || ""
        },
        {
            name: "familyid",
            label: "Family",
            ...
            defaultValue: currentAdmin.familyid?.toString() || ""
        },
        {
            name: "status",
            label: "Status",
