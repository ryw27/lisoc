import { getTeachers, teacherColumns, Teacher } from '@/app/admintest/dashboard/(people-pages)/teacher-view/teacher-helpers'
...
import { deleteTeachers } from '@/app/admintest/dashboard/(people-pages)/teacher-view/teacher-helpers';
