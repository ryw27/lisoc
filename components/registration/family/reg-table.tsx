                ...
                const transferStudent = async () => {
                    ...
                    try {
                        ...
                        const arrObj = [
                            ...
                            ...threeArrs.year,
                            ...threeArrs.spring,
                        ].find((arr) => arr.arrangeid === selectedNewClassId);
                        if (!arrObj) {
                            const msg = "Cannot find new class being transferred to";
                            console.error(msg);
                            setTransferError(msg);
                        ...
                        const res = await familyRequestTransfer(
                            regid,
                            studentid,
                            family.familyid,
                            arrObj,
                    ...
                    <>
                        <Popover>
                            ...
                            <PopoverContent
                                ...
                                sideOffset={5}
                            >
                                {status == REGSTATUS_REGISTERED &&
                                row.original.reqstatus == REQUEST_STATUS_PENDING ? (
                                    <button
                                        className={cn(
                                            cn(
                                    ...
                                    >
                                        <PencilIcon className="h-4 w-4" /> Undo Trans/Drop
                                    </button>
                                ) : (
                                    <>
                                        <button
                                        ...
                                        <button
                                            ...
                                            onClick={(e) => {
                                                ...
                                                if (
                                                    ...
                                                    const msg =
                                                        "Reg ID or studentid for registrations row not found";
                                                    console.error(msg);
                                                    setTransferError(msg);
                                                    setTransferErrorOpen(true);
                                                    return;
                                            ...
                                            disabled={transferDisabled}
                                        >
                                            <PencilIcon className="h-4 w-4" /> Dropout
                                        </button>
                                    </>
                                )}
                            </PopoverContent>
                        ...
                        <AlertDialog open={transferDialogOpen} onOpenChange={setTransferDialogOpen}>
                            <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                    <AlertDialogCancel onClick={() => setTransferDialogOpen(false)}>
                                        Cancel
                                    </AlertDialogCancel>
                                    <AlertDialogAction
                        ...
                        <AlertDialog open={transferErrorOpen} onOpenChange={setTransferErrorOpen}>
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        {transferError ??
                                            "An unknown error occurred while transferring the student."}
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                    <AlertDialogAction onClick={() => setTransferErrorOpen(false)}>
                                        Close
                                    </AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
                        ...
                        <AlertDialog open={dropoutDialogOpen} onOpenChange={setDropoutDialogOpen}>
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        Are you sure you want to drop this student from the class?
                                        你确定要退课吗？
                                    </AlertDialogDescription>
                                    <div className="my-6" />
                                    <label
                                ...
                                <AlertDialogFooter>
                                    <AlertDialogCancel onClick={() => setDropoutDialogOpen(false)}>
                                        Cancel
                                    </AlertDialogCancel>
                                    <AlertDialogAction
                                        onClick={async () => {
