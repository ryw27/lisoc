...
export default function UpdateFamilyForm({
    ...
    infamily: InferSelectModel<typeof family>;
}) {
    ...
    const onSubmit = async (data: z.infer<typeof familySchema>) => {
        try {
            ...
            if (error instanceof z.ZodError) {
                error.issues.map((e) => {
                    familyForm.setError(e.path as unknown as keyof z.infer<typeof familySchema>, {
                        message: e.message,
                    });
                });
        ...
        <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-blue-100 via-white to-blue-300">
            ...
            >
                ...
                <p className="text-black-400 text-sm">
                    请在下表填上准确资料，然后按 “更新” Please fill out the appropriate information
                    below, then press the “Update” button.
                </p>
                <FormInput
