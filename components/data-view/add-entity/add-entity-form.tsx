...
import { insertRow } from "@/server/data-view/actions/insertRow";
...
export default function AddEntityForm({ fields, entity }: AddEntityProps) {
    ...
    const insertReducer = async (_prevState: FormState, formData: FormData) => {
